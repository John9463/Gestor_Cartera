  ...
  <table id="table" class="table table-striped">
    ...
    <tbody>
      <tr>
        ...
        <td>
        <button class="btn btn-warning" onclick="edit('${asesor.id}')"><i class="fas fa-edit">Editar</i></button> 
        <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#myModal" onclick="previusDelete('${asesor.id}')"><i class="far fa-trash-alt">Borrar</i> </button> </td>
      </tr>
    </tbody>
    </g:each>
  </table>
