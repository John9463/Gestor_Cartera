              ...
              <div class="form-group modal-body">
                ...
                <div class="row pt-4">
                  ...
                  <div class="col-4">
                    ...
                    <input type="text" class="form-control"  placeholder="VACO147V5" name="rfc" required>
                  </div>
                ...
                <div class="row pt-4">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control"  placeholder="Av. Tecnologico" name="colonia" required>
                  </div>

                  <div class="col-sm-4">
                    <label for="pwd">Calle:</label>
                    <input type="text" class="form-control"  placeholder="Independencia" name="calle" required>
                  </div>
                ...
                <div class="row pt-4">
                  ...
                  <div class="col-4">
                    ...
                    <input type="number" class="form-control"  placeholder="2000" name="noCasa" minlength="1" required>
                  </div>

                  <div class="col-sm-4">
                    <label for="pwd">Codigo Postal:</label>
                    <input type="number" class="form-control"  placeholder="50100" minlength="5" name="cp" required>
                  </div>

                  <div class="col-4">
                    <label for="pwd">Telefono Celular:</label>
                    <input type="number" class="form-control"  placeholder="7291586478" minlength="10" name="tel" required>
                  </div>
                ...
                <div class="row pt-4">
                      <div class="col-4">
                        ...
                        <input type="text" class="form-control"  placeholder="MyUsername" name="username" required>
                      </div>
