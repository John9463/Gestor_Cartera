    ...
    <g:each var="poliza" in="${ polizas }">
        ...
        <tbody>
          <tr>
            ...
            <td><button class="btn btn-warning" onclick="edit(${poliza.id})"><i class="fas fa-edit">Editar</i></button>
             <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#myModal" onclick="previusDelete(${poliza.id})"><i class="far fa-trash-alt">Borrar</i> </button> </td>
          </tr>
        </tbody>
