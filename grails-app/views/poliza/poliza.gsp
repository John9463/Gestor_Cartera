...
<div class="tabcontent">
  ...
  <button class="btn btn-success" data-toggle="modal" data-target="#modal-poliza" onclick="show('add')"><i class="far fa-plus-square">Crear Poliza</i></button>
    ...
    <g:each var="poliza" in="${ polizas }">
        ...
        <tbody>
          <tr>
            ...
            <td>
            <button class="btn btn-warning" data-toggle="modal" data-target="#modal-poliza" onclick="edit(${poliza.id})"><i class="fas fa-edit">Editar</i></button>
...
<!-- The Modal SQL CREATE / UPDATE-->
  <div class="modal" id="modal-poliza" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">

      <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title" id="title-poliza">Alta de Poliza</h4>
